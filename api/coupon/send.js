...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        await resend.emails.send({
            ...
            to: email,
            subject: 'Seu cupom de 15% OFF esta liberado! - SANTH',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="text-align:center; margin-bottom: 30px;">
                        <h1 style="font-size: 28px; color: #0d0d0d; margin: 0;">SANTH</h1>
                    </div>
                    <h2 style="color: #0d0d0d; text-align: center;">Seu cupom esta liberado!</h2>
                    <p style="color: #666; text-align: center; font-size: 16px;">Obrigado por compartilhar! Use o cupom abaixo na sua primeira compra:</p>
                    ...
                    <p style="color: #666; text-align: center; font-size: 14px;">Continue compartilhando - cada amigo que comprar usando seu link te traz mais beneficios!</p>
                    <div style="text-align: center; margin: 30px 0;">
